          ...
          <div className="flex items-center justify-between h-16 gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0 min-w-0">
              ...
              <button
                ...
                className="md:hidden min-h-[44px] min-w-[44px] p-2 text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl flex items-center justify-center cursor-pointer transition active:scale-95 shrink-0"
              ...
              >
                ...
                />
                <span className="text-xs font-black tracking-tight text-[#0B2046] dark:text-white truncate max-w-[100px] xs:max-w-[130px]">
                  बैंकिङ्ग तयारी
                </span>
              </button>
            </div>
            ...
            <div className="flex items-center gap-1 sm:gap-2 shrink-0">
              ...
              <button
                onClick={() => setIsSearchOpen(true)}
                aria-label="Search"
                className="md:hidden min-h-[40px] min-w-[40px] p-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl flex items-center justify-center transition active:scale-95 shrink-0"
              >
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 text-xs sm:text-sm font-semibold rounded-xl bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800 hover:bg-amber-100 dark:hover:bg-amber-900/60 transition shrink-0"
              ...
              <div 
                className="hidden xs:flex items-center gap-1 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/60 text-amber-700 dark:text-amber-300 px-2 py-1 rounded-xl text-xs font-bold shrink-0"
              ...
              <button
                ...
                className="hidden md:flex p-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition shrink-0"
              ...
              <button
                ...
                className="min-h-[40px] min-w-[40px] p-2 relative text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full flex items-center justify-center cursor-pointer transition focus:outline-none active:scale-95 shrink-0"
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span 
                    ...
                    className="absolute top-1 right-1 flex items-center justify-center min-w-[16px] h-[16px] px-1 text-[9px] font-black font-mono text-white bg-red-600 rounded-full border-2 border-white dark:border-slate-900 shadow-sm animate-pulse"
                  >
              ...
              {/* Header Profile Section & Trigger (Min 40px touch target on mobile) */}
              {isGuest ? (
                <div className="flex items-center gap-1.5 pl-1.5 sm:pl-3 border-l border-slate-200 dark:border-slate-800 shrink-0">
                  <button
                    type="button"
                    onClick={() => openLoginModal()}
                    id="header-login-btn"
                    className="min-h-[38px] px-3 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-700 active:scale-95 text-white text-xs font-bold shadow-xs flex items-center gap-1.5 transition cursor-pointer shrink-0"
                  ...
                  <button
                    ...
                    className="hidden sm:block p-1 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition cursor-pointer shrink-0"
